...
public class UserExcelExporter {
    ...
    public ByteArrayInputStream export(UserReport userReport) {
        return exportNormalFile(userReport);
    }

    private ByteArrayInputStream exportNormalFile(UserReport userReport) {
...
//            sheet.autoSizeColumn(4);
    ...
    private ByteArrayInputStream exportHugeFile(UserReport userReport) {
